...
TIP: The https://market.enonic.com/vendors/enonic/ts-starter[TypeScript Starter] is basically the end result of this tutorial, so when creating your next project - simply run `enonic project create -r starter-ts` to get a best practice development setup, just like that!
